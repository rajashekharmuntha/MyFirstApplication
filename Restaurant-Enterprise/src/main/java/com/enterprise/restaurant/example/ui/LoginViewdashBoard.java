...
public class LoginViewdashBoard extends VerticalLayout implements View {

    public LoginViewdashBoard() {
        setSizeFull();
    ...
    private Component buildFields() {
        ...
        signin.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
             ...
             getMyUI.getLayout().addComponent(new IndexView());
//            getMyUI.navigateTo("index");
           /*  getMyUI.getMainLayout().removeAllComponents();
             getMyUI.getMainLayout().addComponent(new IndexView());*/
    ...
    private Component buildLabels() {
        ...
        welcome.addStyleName("loginLabel");
        ...
        Label title = new Label("Restaurent- Enterprise");
